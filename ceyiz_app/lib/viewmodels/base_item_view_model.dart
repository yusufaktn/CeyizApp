...
abstract class BaseItemViewModel extends ChangeNotifier {
  ...
  Future<void> addPhotoToItem(String id, File photo) async {
    try {
      print(
          'BaseItemViewModel.addPhotoToItem: Adding photo to item ID: $id, photo path: ${photo.path}');
      ...
      print('BaseItemViewModel.addPhotoToItem: Photo saved successfully: $photoUrl');
      ...
      final item = _items[index];
      print('BaseItemViewModel.addPhotoToItem: Current photo URLs: ${item.photoUrls}');

      final updatedPhotoUrls = [...item.photoUrls, photoUrl];
      print('BaseItemViewModel.addPhotoToItem: Updated photo URLs: $updatedPhotoUrls');
